...
function showWitchLetter(){
  $("#witch-letter-modal").classList.add("open");
  $("#witch-letter-modal").setAttribute("aria-hidden","false");
  document.body.classList.add("letter-open");
}

function closeWitchLetter(){
  stopStageMusic();
  $("#witch-letter-modal").classList.remove("open");
  $("#witch-letter-modal").setAttribute("aria-hidden","true");
  document.body.classList.remove("letter-open");
  setTimeout(()=>go("journal"),160);
}
...
ritualButtons.forEach(btn=>btn.onclick=()=>{
  ...
  if(input.length===sequence.length){
    ...
    if(ritualRound===3){
      ...
      playStageMusic(7);
      setTimeout(showWitchLetter,850);
      return;
    }
...
const FINAL_PHOTOS=[
  ...
  "assets/photos/nenemtetemao.png",
  "assets/photos/papai.png",
  "assets/photos/papailiçao.png",
  "assets/photos/pezao.jpg",
  "assets/photos/pisca.png",
  "assets/photos/polo.jpg",
  "assets/photos/ruanfarm.png",
  "assets/photos/ruanita.png",
